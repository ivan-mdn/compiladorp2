...
public class Sintatico {
	...
	public Boolean executa(){
		Util.Log("\nIniciando execução sintático-semântica");
		...
		while(!pilhaSintatico.isEmpty()){
			Util.Log("\nMaquina:"+maquinaAtual.toString()+"  Estado:"+estadoAtual.toString()+" Token:<"+tokemAtual.tipo.toString()+","+tokemAtual.valor+">"+" Transição:"+transicaoSemantica);
			switch (maquinaAtual){
				case ASTIOTA:
...
private Token proximoTokem() throws Exception {
	...
	public String getCodigoFinal() {
		return semantico.codigo.toString();
	}
}
